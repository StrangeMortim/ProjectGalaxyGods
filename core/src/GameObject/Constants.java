...
public final class  Constants {
    ...
    public final static int WOOD_RES_VALUE = 10;
    ...
    public final static int MANA =3;
    public final static int MANA_RES_VALUE = 10;
    public final static int MANA_BONI_VALUE = 3;
    public final static int FIELDXLENGTH=26;
    public final static int FIELDYLENGTH=24;
    public final static int NONE_OR_NOT_SET =-1;
    public final static int FINISHED = 0;
    public final static int NUMBER_NORMAL_FIELDS = 2;
    public final static int NUMBER_MINE_FIELDS = 2;
    public final static int PLAYER_START_WOOD = 500;
