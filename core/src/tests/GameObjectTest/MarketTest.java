...
public class MarketTest {
    ...
    public void testKaufen() throws RemoteException {
        ...
        assertTrue(testMarket.buy(testPlayer,Constants.WOOD, Constants.WOOD_MARKET_DEFAULT_AMOUNT));
        ...
        assertTrue(testMarket.buy(testPlayer,Constants.IRON,Constants.IRON_MARKET_DEFAULT_AMOUNT));
    ...
    public void testKaufenNichtGenugGold() throws RemoteException {
        ...
        assertFalse(testMarket.buy(testPlayer,Constants.WOOD, Constants.WOOD_MARKET_DEFAULT_AMOUNT));
        assertFalse(testMarket.buy(testPlayer,Constants.IRON, Constants.IRON_MARKET_DEFAULT_AMOUNT));
    }
    ...
    public void testVerkaufen() throws RemoteException {
        ...
        assertTrue(testMarket.sell(testPlayer,Constants.WOOD, Constants.PLAYER_START_WOOD));
        assertTrue(testPlayer.getRessources()[Constants.GOLD] == 0 + (Constants.PLAYER_START_WOOD*Constants.WOOD_MARKET_DEFAULT_PRICE));
        goldTmp = testPlayer.getRessources()[Constants.GOLD];
        assertTrue(testMarket.sell(testPlayer,Constants.IRON,Constants.PLAYER_START_IRON));
    ...
    public void testVerkaufenNichtGenugHolz() throws RemoteException {
        ...
        assertFalse(testMarket.sell(testPlayer,Constants.WOOD, Constants.WOOD_MARKET_DEFAULT_AMOUNT));
    }
    ...
    public void testVerkaufenNichtGenugEisen() throws RemoteException {
        ...
        assertFalse(testMarket.sell(testPlayer,Constants.IRON, Constants.IRON_MARKET_DEFAULT_AMOUNT));
    }
