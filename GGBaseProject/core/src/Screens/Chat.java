...
import ProjectGG.ChatInterface;
import ProjectGG.ChatObject;
import ProjectGG.GalaxyGods;
import ProjectGG.ServerInterface;
...
public class Chat implements Screen{
    ...
    public Chat(Game pGame) {
        ...
        while (!chatFound) {
            try {
                chat = (ChatInterface) GalaxyGods.reg.lookup("Chat");
                chatFound = true;
                ...
                try {
                    ServerInterface tmp = (ServerInterface)GalaxyGods.reg.lookup("ServerInterface");
                    tmp.createChat();
